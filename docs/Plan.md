...
> **Bản chi tiết**: [PhanCong-QuayVideo.md](PhanCong-QuayVideo.md) — từng cảnh ghi rõ ai quay, chuẩn bị gì,
> bấm gì, nói gì, cảnh đạt khi nào, kèm checklist chuẩn bị riêng cho A và B và phương án dự phòng.
>
> **Lời thoại nguyên văn + 8 nhóm việc phải làm trước khi quay**: [KichBan-ChiTiet.md](KichBan-ChiTiet.md).
